    ...
    <div className="max-w-md w-full mx-auto p-6 bg-gray-600 rounded-1g shadow-md">
      ...
      <form action="">
        <div className="mb-4">
          ...
          <input placeholder="Name" className="w-full px-3 py-2 border rounded-ig bg-gray-800 focus:border-blue-500" required type="text"></input>
        </div>
        <div className="mb-4">
        <label className="block text-white text-sm font-semibold mb-2" htmlFor="">Your Message</label>
        <textarea rows='4' placeholder="Message" className="w-full px-3 py-2 border rounded-ig bg-gray-800 focus:border-blue-500" required type="text"></textarea>
        </div>
        {/* <div className="mb-4">
